...
<head>
    ...
    <!-- SEO Component -->
    <x-seo :title="$title ?? null" :description="$description ?? null" :keywords="$keywords ?? null" :ogImage="$ogImage ?? null" :canonicalUrl="$canonicalUrl ?? null" :ogType="$ogType ?? 'website'" :robots="$robots ?? 'index, follow'" :schemaMarkup="$schemaMarkup ?? null" />
...
<script src="{{ asset('js/bootstrap.bundle.min.js') }}"></script>
    ...
    @endphp
    @if($settings && $settings->footer_scripts)
